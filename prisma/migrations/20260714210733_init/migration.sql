...
-- AddForeignKey
ALTER TABLE "attachments" ADD CONSTRAINT "fk_task" FOREIGN KEY ("task_id") REFERENCES "NAVTASK"."task"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "subtask" ADD CONSTRAINT "fk_task" FOREIGN KEY ("task_id") REFERENCES "NAVTASK"."task"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "task" ADD CONSTRAINT "fk_user" FOREIGN KEY ("user_id") REFERENCES "NAVTASK"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
